            ...
            const ShowProducts = () => {
                ...
                <>
                    <div className="button d-flex justify-content-center mb-5 pb-5">
                        ...
                        <button onClick={() => filterProduct("covergirl")} className="btn btn-outline-secondary btn-sm">covergirl</button>
                        <button onClick={() => filterProduct("physicians formula")} className="btn btn-outline-secondary btn-sm">physicians formula</button>
                        <button onClick={() => filterProduct("dior")} className="btn btn-outline-secondary btn-sm">dior</button>
                        <button onClick={() => filterProduct("e.l.f.")} className="btn btn-outline-secondary btn-sm">e.l.f.</button>
